                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="border border-dashed rounded p-4 text-center bg-light">
                                                <input type="file" name="image" class="form-control" accept="image/*" onchange="previewImage(event, 'studentPreview')">
                                                <div class="mt-3">
                                                    ...
                                                    <p class="text-muted mt-2 mb-0">Click to upload student photo</p>
                                                </div>
                                            </div>
                                        </div>
